...
class AboutIteration < Neo::Koan
  ...
  # In the first example, the file will be closed and flushed at the
  # end of block while in the second example, the file will remain open.
end
