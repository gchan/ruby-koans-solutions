...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # The += operator creates a new String object which is less efficient
    # if used many times when building Strings. The << operator modifies the
    # existing String and does not create a new object.
  end
